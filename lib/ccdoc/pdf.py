...
class PDFReport():
    ...
    def render(self, handle):
        ...
        doc = MultiColDocTemplate(handle, self.cols, \
...
class PDFGenerator(Generator):
    ...
    def _start_document(self):
        ...
        self.report.setTitle(self.title + u"\n(Subtitle not implemented)")

    def _end_document(self):
        return self.report.render(self._handle)

    def _render_paragraph(self, paragraph):
        ptext = u''
        for text in paragraph.contents:
            ptext += text.text
        self.report.setElements(p(ptext))

    def _render_table(self, table):
        pass

    def _render_section(self, section):
        self.report.setElements(pheader(section.text))
