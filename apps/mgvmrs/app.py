...
class App (rapidsms.app.App):
    ...
    def handle(self, message):
        ...
        if message.text.startswith('omrs'):
            ...
            form.assign('visit_to_health_facility_since_last_home_visit', form.NO)
            ...
            form.assign('current_medication_order', (form.MEDIC_ORDER_ANTIBIOTIC, form.MEDIC_ORDER_ORS))
            ...
            form.assign('reasons_for_referral__abnormal_vaginal_bleeding', False)
            ...
            form2.assign('visit_to_health_facility_since_last_home_visit', form2.NO)
            ...
            form2.assign('current_medication_order', (form2.MEDIC_ORDER_ANTIMALARIAL, form.MEDIC_ORDER_ZINC))
