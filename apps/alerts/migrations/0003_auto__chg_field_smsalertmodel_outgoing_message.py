...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('alerts_smsalertmodel', 'outgoing_message_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['logger_ng.LoggedMessage'], null=True, blank=True))
