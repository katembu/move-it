...
class App (rapidsms.app.App):
    ...
    FORMS = [PatientRegistrationForm, MUACForm, HealthStatusForm, FeverForm, MobileForm, NewbornForm, ChildForm, HouseHoldVisitForm, PregnancyForm, PostpartumForm, ReferralForm]
    MATCH_ALL_LANG_CHAR = '*'
