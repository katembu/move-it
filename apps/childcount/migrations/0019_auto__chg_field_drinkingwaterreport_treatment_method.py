...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DrinkingWaterReport.treatment_method'
        db.alter_column('cc_drnkwater_rpt', 'treatment_method', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True))


    def backwards(self, orm):
        
        # Changing field 'DrinkingWaterReport.treatment_method'
        db.alter_column('cc_drnkwater_rpt', 'treatment_method', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True))
