...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BednetIssuedReport'
        db.create_table('cc_bdnstc_rpt', (
            ...
            ('bednet_received', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('childcount', ['BednetIssuedReport'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'BednetIssuedReport'
        db.delete_table('cc_bdnstc_rpt')
