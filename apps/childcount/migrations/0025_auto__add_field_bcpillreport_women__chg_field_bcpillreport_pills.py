...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BCPillReport.women'
        db.add_column('cc_bcprpt', 'women', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'BCPillReport.pills'
        db.alter_column('cc_bcprpt', 'pills', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'BCPillReport.women'
        db.delete_column('cc_bcprpt', 'women')

        # Changing field 'BCPillReport.pills'
        db.alter_column('cc_bcprpt', 'pills', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
