...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AntenatalVisitReport.hiv'
        db.delete_column('cc_iavrpt', 'hiv')

        # Deleting field 'AntenatalVisitReport.blood_drawn'
        db.delete_column('cc_iavrpt', 'blood_drawn')

        # Deleting field 'AntenatalVisitReport.pregnancy_week'
        db.delete_column('cc_iavrpt', 'pregnancy_week')


    def backwards(self, orm):
        
        # Adding field 'AntenatalVisitReport.hiv'
        db.add_column('cc_iavrpt', 'hiv', self.gf('django.db.models.fields.CharField')(default='U', max_length=1), keep_default=False)

        # Adding field 'AntenatalVisitReport.blood_drawn'
        db.add_column('cc_iavrpt', 'blood_drawn', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'AntenatalVisitReport.pregnancy_week'
        db.add_column('cc_iavrpt', 'pregnancy_week', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1), keep_default=False)
