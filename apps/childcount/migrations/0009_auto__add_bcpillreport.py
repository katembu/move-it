...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BCPillReport'
        db.create_table('cc_bcprpt', (
            ...
            ('pills', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('childcount', ['BCPillReport'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'BCPillReport'
        db.delete_table('cc_bcprpt')
