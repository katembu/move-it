...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Encounter', fields ['encounter_date']
        db.create_index('cc_encounter', ['encounter_date'])

        # Adding index on 'Encounter', fields ['type']
        db.create_index('cc_encounter', ['type'])


    def backwards(self, orm):
        
        # Removing index on 'Encounter', fields ['type']
        db.delete_index('cc_encounter', ['type'])

        # Removing index on 'Encounter', fields ['encounter_date']
        db.delete_index('cc_encounter', ['encounter_date'])
