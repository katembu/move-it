...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CodedItem.description'
        db.delete_column('cc_codeditem', 'description')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'CodedItem.description'
        db.add_column('cc_codeditem', 'description', self.gf('django.db.models.fields.CharField')(default=datetime.date(2010, 6, 8), max_length=100), keep_default=False)
