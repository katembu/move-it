...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SanitationReport.share_toilet'
        db.alter_column('cc_sanitation_rpt', 'share_toilet', self.gf('django.db.models.fields.SmallIntegerField')(max_length=1))

        # Changing field 'BednetUtilization.hanging_bednet'
        db.alter_column('cc_bdnutil_rpt', 'hanging_bednet', self.gf('django.db.models.fields.SmallIntegerField')())

        # Deleting field 'DrinkingWaterReport.treat_water'
        db.delete_column('cc_drnkwater_rpt', 'treat_water')


    def backwards(self, orm):
        
        # Changing field 'SanitationReport.share_toilet'
        db.alter_column('cc_sanitation_rpt', 'share_toilet', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'BednetUtilization.hanging_bednet'
        db.alter_column('cc_bdnutil_rpt', 'hanging_bednet', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Adding field 'DrinkingWaterReport.treat_water'
        db.add_column('cc_drnkwater_rpt', 'treat_water', self.gf('django.db.models.fields.CharField')(default=0, max_length=1), keep_default=False)
    ...
    models = {
        ...
        'childcount.sanitationreport': {
            ...
            'ccreport_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['childcount.CCReport']", 'unique': 'True', 'primary_key': 'True'}),
            'share_toilet': ('django.db.models.fields.SmallIntegerField', [], {'max_length': '1'}),
