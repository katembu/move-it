...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Patient.latitude'
        db.add_column('cc_patient', 'latitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=6, blank=True), keep_default=False)

        # Adding field 'Patient.longitude'
        db.add_column('cc_patient', 'longitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=6, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Patient.latitude'
        db.delete_column('cc_patient', 'latitude')

        # Deleting field 'Patient.longitude'
        db.delete_column('cc_patient', 'longitude')
