...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AppointmentReport.sms_alert'
        db.add_column('cc_appointment', 'sms_alert', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alerts.SmsAlertModel'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AppointmentReport.sms_alert'
        db.delete_column('cc_appointment', 'sms_alert_id')
    ...
    models = {
        ...
        'childcount.dbsresultreport': {
            ...
            'ccreport_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['childcount.CCReport']", 'unique': 'True', 'primary_key': 'True'}),
            'returned': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'})
        },
