...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DBSResultReport.returned'
        db.delete_column('cc_dbsresult', 'returned')

        # Adding field 'DBSResultReport.test_result'
        db.add_column('cc_dbsresult', 'test_result', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'DBSResultReport.returned'
        db.add_column('cc_dbsresult', 'returned', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Deleting field 'DBSResultReport.test_result'
        db.delete_column('cc_dbsresult', 'test_result')
