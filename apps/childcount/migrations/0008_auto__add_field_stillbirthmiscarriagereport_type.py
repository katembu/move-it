...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StillbirthMiscarriageReport.type'
        db.add_column('cc_sbmcrpt', 'type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'StillbirthMiscarriageReport.type'
        db.delete_column('cc_sbmcrpt', 'type')
