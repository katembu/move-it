...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BednetUtilization'
        db.create_table('cc_bdnutil_rpt', (
            ...
            ('child_underfive', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('child_lastnite', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('childcount', ['BednetUtilization'])


    def backwards(self, orm):
        
        # Deleting model 'BednetUtilization'
        db.delete_table('cc_bdnutil_rpt')
