...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PatientStatusReport'
        db.create_table('cc_patientstatus', (
        ...
        db.send_create_signal('childcount', ['PatientStatusReport'])


    def backwards(self, orm):
        
        # Deleting model 'PatientStatusReport'
        db.delete_table('cc_patientstatus')
