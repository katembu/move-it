...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExtendedBedNetReport'
        db.create_table('cc_ebnrpt', (
            ...
            ('damaged_nets', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('childcount', ['ExtendedBedNetReport'])


    def backwards(self, orm):
        
        # Deleting model 'ExtendedBedNetReport'
        db.delete_table('cc_ebnrpt')
