...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AppointmentReport'
        db.create_table('cc_appointment', (
        ...
        db.send_create_signal('childcount', ['AppointmentReport'])


    def backwards(self, orm):
        
        # Deleting model 'AppointmentReport'
        db.delete_table('cc_appointment')
