...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cc_sauri_pregrpt', (
            ...
            ('tested_hiv', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('pregnancyreport_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['childcount.PregnancyReport'], unique=True, primary_key=True)),
