...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeadPerson.dob'
        db.alter_column('cc_dead_person', 'dob', self.gf('django.db.models.fields.DateField')())

        # Changing field 'DeadPerson.household'
        db.alter_column('cc_dead_person', 'household_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['childcount.Patient']))

        # Changing field 'DeadPerson.dod'
        db.alter_column('cc_dead_person', 'dod', self.gf('django.db.models.fields.DateField')())
    
    
    def backwards(self, orm):
        
        # Changing field 'DeadPerson.dob'
        db.alter_column('cc_dead_person', 'dob', self.gf('django.db.models.fields.DateField')(null=True, blank=True))

        # Changing field 'DeadPerson.household'
        db.alter_column('cc_dead_person', 'household_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['childcount.DeadPerson'], blank=True))

        # Changing field 'DeadPerson.dod'
        db.alter_column('cc_dead_person', 'dod', self.gf('django.db.models.fields.DateField')(null=True, blank=True))
