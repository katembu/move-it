...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DistributionPoints'
        db.create_table('cc_distribution_points', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='chwdistributionsite', null=True, to=orm['locations.Location'])),
        ))
        db.send_create_signal('childcount', ['DistributionPoints'])

        # Adding M2M table for field chw on 'DistributionPoints'
        db.create_table('cc_distribution_points_chw', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('distributionpoints', models.ForeignKey(orm['childcount.distributionpoints'], null=False)),
            ('chw', models.ForeignKey(orm['childcount.chw'], null=False))
        ))
        db.create_unique('cc_distribution_points_chw', ['distributionpoints_id', 'chw_id'])


    def backwards(self, orm):
        
        # Deleting model 'DistributionPoints'
        db.delete_table('cc_distribution_points')

        # Removing M2M table for field chw on 'DistributionPoints'
        db.delete_table('cc_distribution_points_chw')
    ...
    models = {
        ...
        'childcount.dbsresultreport': {
            ...
            'ccreport_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['childcount.CCReport']", 'unique': 'True', 'primary_key': 'True'}),
            'test_result': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'})
        },
        ...
        'childcount.distributionpoints': {
            ...
            'chw': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['childcount.CHW']", 'db_index': 'True', 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'childcount.poliocampaignreport': {
            'Meta': {'unique_together': "(('patient', 'phase'),)", 'object_name': 'PolioCampaignReport', 'db_table': "'cc_poliocampaign'"},
            'chw': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['childcount.CHW']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'patient': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['childcount.Patient']"}),
        ...
        'logger_ng.loggedmessage': {
            'Meta': {'object_name': 'LoggedMessage'},
