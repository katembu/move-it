...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'CodedItem', fields ['code']
        db.create_index('cc_codeditem', ['code'])

        # Adding index on 'CodedItem', fields ['type']
        db.create_index('cc_codeditem', ['type'])


    def backwards(self, orm):
        
        # Removing index on 'CodedItem', fields ['type']
        db.delete_index('cc_codeditem', ['type'])

        # Removing index on 'CodedItem', fields ['code']
        db.delete_index('cc_codeditem', ['code'])
