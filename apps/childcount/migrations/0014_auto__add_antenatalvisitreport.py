...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AntenatalVisitReport'
        db.create_table('cc_iavrpt', (
            ...
            ('pregnancy_week', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('expected_on', self.gf('django.db.models.fields.DateTimeField')()),
            ('hiv', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('blood_drawn', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        db.send_create_signal('childcount', ['AntenatalVisitReport'])


    def backwards(self, orm):
        
        # Deleting model 'AntenatalVisitReport'
        db.delete_table('cc_iavrpt')
