...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AntenatalVisitReport.sms_alert'
        db.add_column('cc_iavrpt', 'sms_alert', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alerts.SmsAlertModel'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AntenatalVisitReport.sms_alert'
        db.delete_column('cc_iavrpt', 'sms_alert_id')
