...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DrinkingWaterReport'
        db.create_table('cc_drnkwater_rpt', (
            ...
            ('water_source', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('treat_water', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('treatment_method', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
        ))
        db.send_create_signal('childcount', ['DrinkingWaterReport'])

        # Adding model 'SanitationReport'
        db.create_table('cc_sanitation_rpt', (
            ('ccreport_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['childcount.CCReport'], unique=True, primary_key=True)),
            ('toilet_lat', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('share_toilet', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('childcount', ['SanitationReport'])


    def backwards(self, orm):
        
        # Deleting model 'DrinkingWaterReport'
        db.delete_table('cc_drnkwater_rpt')

        # Deleting model 'SanitationReport'
        db.delete_table('cc_sanitation_rpt')
    ...
    models = {
        ...
        'childcount.drinkingwaterreport': {
            ...
            'water_source': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
        ...
        'childcount.sanitationreport': {
            ...
            'toilet_lat': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
