...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HIVTestReport'
        db.create_table('cc_hivtest', (
            ...
            ('hiv', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('blood_drawn', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('childcount', ['HIVTestReport'])


    def backwards(self, orm):
        
        # Deleting model 'HIVTestReport'
        db.delete_table('cc_hivtest')
