...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ImmunizationNotification'
        db.create_table('cc_immunnotif', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['childcount.Patient'])),
            ('immunization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['childcount.ImmunizationSchedule'])),
            ('notify_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('notified_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('childcount', ['ImmunizationNotification'])

        # Adding model 'ImmunizationSchedule'
        db.create_table('cc_immunsched', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('period', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('period_type', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('immunization', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('childcount', ['ImmunizationSchedule'])


    def backwards(self, orm):
        
        # Deleting model 'ImmunizationNotification'
        db.delete_table('cc_immunnotif')

        # Deleting model 'ImmunizationSchedule'
        db.delete_table('cc_immunsched')
