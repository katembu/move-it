...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DeadPerson'
        db.create_table('cc_dead_person', (
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('dob', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('gender', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('household', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='household_member', null=True, to=orm['childcount.DeadPerson'])),
            ...
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='deadpsresident', null=True, to=orm['locations.Location'])),
            ('chw', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['childcount.CHW'])),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('childcount', ['DeadPerson'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'DeadPerson'
        db.delete_table('cc_dead_person')
    ...
    models = {
        ...
        'childcount.deadperson': {
            ...
            'household': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'household_member'", 'null': 'True', 'to': "orm['childcount.DeadPerson']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'deadpsresident'", 'null': 'True', 'to': "orm['locations.Location']"}),
