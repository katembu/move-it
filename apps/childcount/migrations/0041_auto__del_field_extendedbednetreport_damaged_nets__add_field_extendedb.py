...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ExtendedBedNetReport.damaged_nets'
        db.delete_column('cc_ebnrpt', 'damaged_nets')

        # Adding field 'ExtendedBedNetReport.people'
        db.add_column('cc_ebnrpt', 'people', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ExtendedBedNetReport.damaged_nets'
        db.add_column('cc_ebnrpt', 'damaged_nets', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Deleting field 'ExtendedBedNetReport.people'
        db.delete_column('cc_ebnrpt', 'people')
    ...
    models = {
        ...
        'childcount.extendedbednetreport': {
            'Meta': {'object_name': 'ExtendedBedNetReport', 'db_table': "'cc_ebnrpt'", '_ormbases': ['childcount.CCReport']},
            'ccreport_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['childcount.CCReport']", 'unique': 'True', 'primary_key': 'True'}),
