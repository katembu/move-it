...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BednetStock.end_point'
        db.alter_column('cc_bednetstock', 'end_point', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'BednetStock.end_point'
        db.alter_column('cc_bednetstock', 'end_point', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
