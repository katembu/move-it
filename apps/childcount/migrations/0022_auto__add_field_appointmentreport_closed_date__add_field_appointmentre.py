...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AppointmentReport.closed_date'
        db.add_column('cc_appointment', 'closed_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'AppointmentReport.notification_sent'
        db.add_column('cc_appointment', 'notification_sent', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'AppointmentReport.status'
        db.add_column('cc_appointment', 'status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AppointmentReport.closed_date'
        db.delete_column('cc_appointment', 'closed_date')

        # Deleting field 'AppointmentReport.notification_sent'
        db.delete_column('cc_appointment', 'notification_sent')

        # Deleting field 'AppointmentReport.status'
        db.delete_column('cc_appointment', 'status')
