...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SanitationReport.toilet_lat'
        db.alter_column('cc_sanitation_rpt', 'toilet_lat', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Adding field 'BednetUtilization.hanging_bednet'
        db.add_column('cc_bdnutil_rpt', 'hanging_bednet', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'BednetUtilization.reason'
        db.add_column('cc_bdnutil_rpt', 'reason', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)

        # Deleting field 'BedNetReport.nets'
        db.delete_column('cc_bnrpt', 'nets')

        # Adding field 'BedNetReport.function_nets'
        db.add_column('cc_bnrpt', 'function_nets', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'BedNetReport.earlier_nets'
        db.add_column('cc_bnrpt', 'earlier_nets', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'BedNetReport.damaged_nets'
        db.add_column('cc_bnrpt', 'damaged_nets', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Changing field 'DrinkingWaterReport.water_source'
        db.alter_column('cc_drnkwater_rpt', 'water_source', self.gf('django.db.models.fields.CharField')(max_length=2))


    def backwards(self, orm):
        
        # Changing field 'SanitationReport.toilet_lat'
        db.alter_column('cc_sanitation_rpt', 'toilet_lat', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Deleting field 'BednetUtilization.hanging_bednet'
        db.delete_column('cc_bdnutil_rpt', 'hanging_bednet')

        # Deleting field 'BednetUtilization.reason'
        db.delete_column('cc_bdnutil_rpt', 'reason')

        # Adding field 'BedNetReport.nets'
        db.add_column('cc_bnrpt', 'nets', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Deleting field 'BedNetReport.function_nets'
        db.delete_column('cc_bnrpt', 'function_nets')

        # Deleting field 'BedNetReport.earlier_nets'
        db.delete_column('cc_bnrpt', 'earlier_nets')

        # Deleting field 'BedNetReport.damaged_nets'
        db.delete_column('cc_bnrpt', 'damaged_nets')

        # Changing field 'DrinkingWaterReport.water_source'
        db.alter_column('cc_drnkwater_rpt', 'water_source', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        'childcount.bednetutilization': {
            ...
            'hanging_bednet': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
        ...
        'childcount.drinkingwaterreport': {
            ...
            'ccreport_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['childcount.CCReport']", 'unique': 'True', 'primary_key': 'True'}),
            'treat_water': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'treatment_method': ('django.db.models.fields.CharField', [], {'max_length': '1', 'blank': 'True'}),
        ...
        'childcount.pregnancyregistrationreport': {
            ...
            'ccreport_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['childcount.CCReport']", 'unique': 'True', 'primary_key': 'True'}),
            'married': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
        ...
        'childcount.sanitationreport': {
            ...
            'ccreport_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['childcount.CCReport']", 'unique': 'True', 'primary_key': 'True'}),
            'share_toilet': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
