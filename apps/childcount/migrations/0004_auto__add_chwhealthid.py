...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CHWHealthId'
        db.create_table('cc_chwhealthid', (
            ('health_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['childcount.HealthId'], unique=True)),
            ('issued_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('used', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('chw', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['childcount.CHW'], null=True, blank=True)),
        ))
        db.send_create_signal('childcount', ['CHWHealthId'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CHWHealthId'
        db.delete_table('cc_chwhealthid')
