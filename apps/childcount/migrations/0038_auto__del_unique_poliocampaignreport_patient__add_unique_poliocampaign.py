...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'PolioCampaignReport', fields ['patient']
        db.delete_unique('cc_poliocampaign', ['patient_id'])

        # Adding unique constraint on 'PolioCampaignReport', fields ['phase', 'patient']
        db.create_unique('cc_poliocampaign', ['phase', 'patient_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'PolioCampaignReport', fields ['patient']
        db.create_unique('cc_poliocampaign', ['patient_id'])

        # Removing unique constraint on 'PolioCampaignReport', fields ['phase', 'patient']
        db.delete_unique('cc_poliocampaign', ['phase', 'patient_id'])
