...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PolioCampaignReport'
        db.create_table('cc_poliocampaign', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['childcount.Patient'], unique=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('chw', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['childcount.CHW'])),
        ))
        db.send_create_signal('childcount', ['PolioCampaignReport'])


    def backwards(self, orm):
        
        # Deleting model 'PolioCampaignReport'
        db.delete_table('cc_poliocampaign')
