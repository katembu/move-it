...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DBSResultReport'
        db.create_table('cc_dbsresult', (
            ...
            ('returned', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        db.send_create_signal('childcount', ['DBSResultReport'])


    def backwards(self, orm):
        
        # Deleting model 'DBSResultReport'
        db.delete_table('cc_dbsresult')
