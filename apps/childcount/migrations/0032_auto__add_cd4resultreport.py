...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CD4ResultReport'
        db.create_table('cc_cd4result', (
            ...
            ('cd4_count', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('childcount', ['CD4ResultReport'])


    def backwards(self, orm):
        
        # Deleting model 'CD4ResultReport'
        db.delete_table('cc_cd4result')
