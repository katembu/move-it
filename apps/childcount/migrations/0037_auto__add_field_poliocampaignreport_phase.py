...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PolioCampaignReport.phase'
        db.add_column('cc_poliocampaign', 'phase', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PolioCampaignReport.phase'
        db.delete_column('cc_poliocampaign', 'phase')
