...
urlpatterns = patterns('',
    ...
    url(r'^childcount/reports/underfive-(?P<clinic>[a-z]*)'
        '.(?P<rformat>[a-z]*)$', reports.gen_underfive_register_pdf),
    url(r'^childcount/reports/hhsurvey-(?P<clinic>[a-z]*)'
        '.(?P<rformat>[a-z]*)$', reports.gen_household_surveyreport),
    ...
    url(r'^childcount/charts/polio-phase-(?P<phase>[0-9]*)-barchart.'
        '(?P<cformat>[a-z]*)$', charts.polio_percentage_barchart),
    url(r'^childcount/charts/polio-malefemaleratio-phase-(?P<phase>[0-9]*)-'
        'barchart.(?P<cformat>[a-z]*)$', charts.polio_malefemale_summary),
    url(r'^childcount/charts/polio-pcomparison-barchart.(?P<cformat>[a-z]*)$',
        charts.polio_percentage_comparison_barchart),
    url(r'^childcount/charts/polio-dailysummary-comparison-barchart.'
        '(?P<cformat>[a-z]*)$', charts.polio_daily_summary_comparison),
    url(r'^childcount/charts/polio-dailysummary-phase-(?P<phase>[0-9]*)'
