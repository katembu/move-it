...
urlpatterns = patterns('',
    ...
    url(r'^childcount/reports/ccforms-summary.(?P<rformat>[a-z]*)$',
            reports.ccforms_summary),
    url(r'^childcount/reports/ccreports-summary.(?P<rformat>[a-z]*)$',
            reports.ccreports_summary),
