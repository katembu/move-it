...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GeneratedReport.task_progress'
        db.add_column('reportgen_generated_report', 'task_progress', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=100), keep_default=False)

        # Adding field 'GeneratedReport.task_state'
        db.add_column('reportgen_generated_report', 'task_state', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GeneratedReport.task_progress'
        db.delete_column('reportgen_generated_report', 'task_progress')

        # Deleting field 'GeneratedReport.task_state'
        db.delete_column('reportgen_generated_report', 'task_state')
