...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'GeneratedReport', fields ['filename']
        db.delete_unique('reportgen_generated_report', ['filename'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'GeneratedReport', fields ['filename']
        db.create_unique('reportgen_generated_report', ['filename'])
