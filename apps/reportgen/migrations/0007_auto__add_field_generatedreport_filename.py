...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GeneratedReport.filename'
        db.add_column('reportgen_generated_report', 'filename', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=255, db_index=True), keep_default=False)
