...
'''
NightlyReport holds information about reports
that should be generated every night. All formats
and variants for a report are generated.

The only data (besides the report name itself)
that NightlyReport holds is the time period
with which to generate the report.
'''
